...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar a un atleta");
		System.out.println("14. Salir de la aplicación\n");
		System.out.println("15. Modificaci�n\n");
	}
	...
	private void ejecutarConsultarAtleta()
	{
		System.out.println("\n" + "Consulta de un atleta" + "\n");
		{
			String nombreAtleta = input("Ingrese el nombre del atleta que le interesa");
			String nombrePais = calculadora.consultarAtleta(nombreAtleta);
			if (nombreAtleta == null)
			{
				System.out.println("No se encontró un atleta llamado " + nombreAtleta);
			}
			else
			{
				System.out.println("El atleta " + nombreAtleta + " pertenece al pa�s " + nombrePais);
			}
		}
		}
	...
	private void ejecutarCargarAtletas()
	{
		...
		try
		{
			...
			if (paises.size() > 1)
			{
				System.out.println("Hay " + paises.size() + " pa�ses empatados por el primer lugar.");
			}
			for (String nombre : paises.keySet())
			{
				System.out.println(nombre + " ha tenido " + paises.get(nombre) + " medallistas.");	
